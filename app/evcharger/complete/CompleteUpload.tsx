  ...
  return (
    <section className="complete-shell">
      <div className="complete-card">
        ...
        <p>
          We received your deposit and will follow up soon to confirm the install window.
          {canUpload && (
            <>
              {' '}
              Use the uploader below to share ceiling or panel photos so we can finalize the plan.
            </>
          )}
        </p>
        {!canUpload && (
